                        ...
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".3s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a href="https://goo.gl/maps/Zd4BCynmTb98ivUJ6" target="_blank" className="h5">Madhyapur
                                        Thimi - 7,Bhaktapur</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a className="h5" href="tel:+9779704788132" target="_blank">+977 9704788132</a>
                                </div>
                            </div>
                        </div>
                        <div className="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                            <div className="d-flex bg-light p-3 rounded">
                                ...
                                <div className="ms-3">
                                    ...
                                    <a className="h5" href="mailto:kojuitsolutions@gmail.com"
                                        target="_blank">kojuitsolutions@gmail.com</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="row g-5">
                        ...
                        <div className="col-lg-6 wow fadeIn" data-wow-delay=".5s">
                            <form action={formAction} className="p-5 rounded contact-form">
                                {state.message && (
                                    <div className={`alert ${state.success ? 'alert-success' : 'alert-danger'} mb-4`} role="alert">
                                        {state.message}
                                    </div>
                                )}
                                <div className="mb-4">
                                ...
                                <div className="mb-4">
                                    <input type="text" name="project" className="form-control border-0 py-3" placeholder="Project" />
                                </div>
                                <div className="mb-4">
                                    <textarea name="message" className="w-100 form-control border-0 py-3" rows={6} cols={10}
