                ...
                <div className="d-flex justify-content-between topbar">
                    <div className="top-info">
                        <small className="me-3 text-white-50"><a href="#"><i
                            className="fas fa-map-marker-alt me-2 text-secondary"></i></a>Madhyapur
                            Thimi-7,Bhaktapur</small>
                        <small className="me-3 text-white-50"><a href="mailto:kojuitsolutions@gmail.com"><i
                            className="fas fa-envelope me-2 text-secondary"></i></a>kojuitsolutions@gmail.com</small>
                    </div>
